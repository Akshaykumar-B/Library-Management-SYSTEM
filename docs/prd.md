...
A web-based library management system that enables users to borrow and return books while allowing library staff to manage book inventory and track transactions. The system supports different user roles with specific permissions and borrowing rules. Users can open and read borrowed books online with access to full page content and take personal notes.
...
### 2.7 Role-Based Interface Views
- Student/Teacher View: Simplified interface focused on browsing, borrowing, reading books, and managing personal notes
- Staff View: Comprehensive dashboard with inventory management, user transaction oversight, and system administration tools
